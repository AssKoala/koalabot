...
{
    using perfCounter = Global.getPerformanceCounter("handleDicerollCommand(): ");
    ...
    try {
        ...
        await Global.logger().logError(`Top level exception during dice roll, got error ${e}`, interaction, true);
    }
...
Global.registerCommandModule(registerDicerollCommand, getDicerollJSON);

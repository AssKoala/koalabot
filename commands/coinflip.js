...
async function handleCoinflipCommand(interaction)
 {
    const start = Common.startTiming(`handleCoinflipCommand(): `);
    ...
    try {
        ...
        await Common.logError(`Top level exception during coin flip, got error ${e}`, interaction, true);
    }
...
Common.registerCommandModule(registerCoinflipCommand, getCoinflipJSON);

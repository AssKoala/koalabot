...
All bot features can be configured by overriding the various options listed in _config/default.json5_.

The particularly confidential (and required) options can also be overridden via environment variables.  See _config/custom-environment-variables.json5_ the full list.
